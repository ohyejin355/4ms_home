  ...
  <main>
    <div class="relative pt-16 md:pt-20">
      <div
        ...
        style="
          background-image: url(../../src/assets/image/sub/sub_visual_img_bg.png);
        "
      >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-center mb-16">
            <div class="bg-slate-100 p-8 rounded-lg">
              ...
              <p class="text-slate-600 mb-4">
                시스템 개발 문의는 다음 메일로 연락주시면<br />빠른 시일 내 답변
                드리겠습니다.
              </p>
              <a
            ...
            <div class="bg-slate-100 p-8 rounded-lg">
              ...
              <p class="text-slate-600 mb-4">
                시스템 운영 문의는 다음 메일로 연락주시면<br />빠른 시일 내 답변
                드리겠습니다.
              </p>
              <a
...
const initKakaoMap = () => {
  ...
  if (window.kakao && window.kakao.maps) {
    ...
    console.error(
      "Kakao Map API가 정의되지 않았습니다. index.html을 확인하세요.",
    )
  }
}
