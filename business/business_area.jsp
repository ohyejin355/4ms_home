                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                ...
                                <p class="mt-3 text-slate-600 leading-relaxed">고객의 비즈니스 환경에 최적화된 유통/물류 시스템 구축을 위한 전문 컨설팅을 제공합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                            ...
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                ...
                                <p class="mt-3 text-slate-600 leading-relaxed">생산부터 유통까지, 축산낙농 분야의 복잡한 데이터를 통합 관리하는 효율적인 방안을 제시합니다.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                ...
                                <p class="mt-3 text-sm text-slate-600 leading-relaxed">기업의 핵심 자원(ERP) 및 고객 관계(CRM) 관리를 위한 맞춤형 시스템을 개발합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                <img src="/imgae/sub/pro_logo_02.png" alt="공공 부문" class="mx-auto mb-6 h-16">
                                <h4 class="text-xl font-bold text-slate-800">공공 부문</h4>
                                <p class="mt-3 text-sm text-slate-600 leading-relaxed">투명하고 효율적인 대국민 서비스를 위한 공공기관 정보 시스템을 구축합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                <img src="/imgae/sub/pro_logo_03.png" alt="제조 부문" class="mx-auto mb-6 h-16">
                                <h4 class="text-xl font-bold text-slate-800">제조 부문</h4>
                                <p class="mt-3 text-sm text-slate-600 leading-relaxed">생산관리시스템(MES) 및 품질 관리 시스템을 제공하여 생산 공정의 효율을 극대화합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                <img src="/imgae/sub/pro_logo_04.png" alt="유통 부문" class="mx-auto mb-6 h-16">
                                <h4 class="text-xl font-bold text-slate-800">유통 부문</h4>
                                <p class="mt-3 text-sm text-slate-600 leading-relaxed">실시간 재고, 주문, 배송 추적이 가능한 통합 유통 관리 플랫폼을 개발합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                <img src="/imgae/sub/pro_logo_05.png" alt="축산 부문" class="mx-auto mb-6 h-16">
                                <h4 class="text-xl font-bold text-slate-800">축산 부문</h4>
                                <p class="mt-3 text-sm text-slate-600 leading-relaxed">농가별 사육 환경, 출하 정보 등을 체계적으로 관리하는 스마트 축산 시스템을 구현합니다.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                ...
                                <p class="mt-3 text-slate-600 leading-relaxed">다양한 산업 분야에 필요한 특정 목적의 데스크톱 및 웹 기반 응용 프로그램을 개발합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                ...
                                <p class="mt-3 text-slate-600 leading-relaxed">기업의 정체성을 담은 반응형 웹사이트를 구축하여 효과적인 온라인 홍보를 지원합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                ...
                                <p class="mt-3 text-slate-600 leading-relaxed">안정적이고 확장 가능한 B2B 및 B2C E-커머스 플랫폼을 제공합니다.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                ...
                                <p class="mt-3 text-slate-600 leading-relaxed">개발된 시스템이 최적의 성능을 유지하도록 지속적인 모니터링과 업데이트를 지원합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                ...
                                <p class="mt-3 text-slate-600 leading-relaxed">IT 인프라 전반에 대한 24/7 운영 및 관리로 비즈니스의 연속성을 보장합니다.</p>
                            </div>
                            <div class="bg-white p-8 rounded-lg shadow-md text-center">
                                <img src="/imgae/sub/pro_logo_09.png" alt="고객지원" class="mx-auto mb-6 h-20">
                                <h4 class="text-xl font-bold text-slate-800">고객지원</h4>
                                <p class="mt-3 text-slate-600 leading-relaxed">시스템 사용 중 발생하는 모든 기술적 문의와 문제에 대해 신속하고 정확하게 지원합니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
